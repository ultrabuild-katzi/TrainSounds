...
val geckolib_version = property("geckolib_version") as String
...
repositories {
    ...
    maven {
        ...
        maven {
            name = "JamiesWhiteShirt Maven"; description = "Reach Entity Attributes"; url =
            uri("https://maven.jamieswhiteshirt.com/libs-release")
        }


        maven {
            name = "Jitpack maven"; description = "Mixin Extras & Fabric ASM"; url = uri("https://jitpack.io/")
